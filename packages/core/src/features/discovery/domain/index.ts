import {
  ...
  type Stream,
  type Video,
} from "../../content/domain/index.ts";
import type { TopStreamReader } from "../capabilities/discovery.ts";
import type { Platform } from "../../../platform/index.ts";
import { normalizeSearchTokens } from "./discovery-rules.ts";
