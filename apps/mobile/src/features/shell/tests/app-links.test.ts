...
import type { ShellRestorationRepository } from "@mobile/features/storage/capabilities/persistence";
import {
  applyShellStartupInputs,
  writeShellSnapshot,
} from "@mobile/features/shell/components/shell-lifecycle-controller";
import {
