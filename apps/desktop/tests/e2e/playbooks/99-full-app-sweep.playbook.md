...
|    12 | `/mod`                                                        | `.scratch/images/sweep-12-mod.png`             |
|    13 | `/mod/twitch/ninja`                                           | `.scratch/images/sweep-13-mod-twitch.png`      |
|    14 | `/mod/kick/ninja`                                             | `.scratch/images/sweep-14-mod-kick.png`        |

## Pass criteria

- [ ] All 14 routes mount with no JS exceptions in renderer logs.
