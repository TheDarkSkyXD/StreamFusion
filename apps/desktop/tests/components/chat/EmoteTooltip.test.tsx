...
import { EmoteTooltip } from "@/features/chat/components/chat/tooltips/EmoteTooltip";
...
describe("EmoteTooltip", () => {
  ...
  it("uses the 2x image for previews instead of the heavier 4x asset", () => {
    render(<EmoteTooltip show={true} mousePos={{ x: 100, y: 100 }} emote={emote} />);
    expect(screen.getByAltText("KAPPA")).toHaveAttribute("src", "b");
  });
