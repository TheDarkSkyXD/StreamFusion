...
vi.mock("@backend/features/chat/adapters/seventv/7tv-emotes-service", () => ({
  fetch7TVUserByConnection: serviceMock.fetch7TVUserByConnection,
  fetch7TVGlobalEmoteSet: serviceMock.fetch7TVGlobalEmoteSet,
}));
vi.mock("@backend/features/chat/adapters/bttv/bttv-emotes-service", () => ({
...
vi.mock("@backend/features/chat/adapters/ffz/ffz-emotes-service", () => ({
...
vi.mock("@backend/features/chat/adapters/kick/kick-channel-emotes-service", () => ({
  fetchKickChannelEmotes: serviceMock.fetchKickChannelEmotes,
}));
vi.mock("@backend/features/chat/adapters/kick/kick-user-subscriptions-service", () => ({
  fetchKickUserSubscriptions: serviceMock.fetchKickUserSubscriptions,
}));

import { registerEmoteHandlers } from "@backend/features/chat/routes/emote-routes";
