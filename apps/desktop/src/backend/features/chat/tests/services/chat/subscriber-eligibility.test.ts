...
vi.mock("@backend/features/authentication/data/authentication-repository", () => ({
  authenticationRepository: storageMock,
}));

vi.mock(
  "@backend/features/chat/adapters/kick/kick-user-subscriptions-service",
  () => kickSubscriptionsMock
);
...
} from "@backend/features/chat/adapters/platform/subscriber-eligibility";
