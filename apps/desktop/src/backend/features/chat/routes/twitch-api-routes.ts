import { twitchModViewCommandSchemas } from "@backend/features/moderation/routes/twitch-mod-view-command-schema";
...
} from "@backend/features/moderation/adapters/twitch/twitch-eventsub-feed-service";
import { registerTwitchEventSubRoutes } from "@backend/features/moderation/routes/twitch-eventsub-routes";
...
export function registerTwitchApiRoutes({
  ...
  registerTwitchEventSubRoutes({ eventSub, renderer });
  ipcMain.handle(
