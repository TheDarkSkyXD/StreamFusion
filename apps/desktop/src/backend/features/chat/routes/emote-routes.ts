...
} from "@backend/features/chat/adapters/seventv/7tv-emotes-service";
import {
  fetchBTTVBadges,
  fetchBTTVGlobalEmotes,
  fetchBTTVUserByTwitchId,
} from "@backend/features/chat/adapters/bttv/bttv-emotes-service";
import {
  fetchFFZBadges,
  fetchFFZGlobalEmotes,
  fetchFFZRoom,
} from "@backend/features/chat/adapters/ffz/ffz-emotes-service";
import { fetchKickChannelEmotes } from "@backend/features/chat/adapters/kick/kick-channel-emotes-service";
import { fetchKickUserSubscriptions } from "@backend/features/chat/adapters/kick/kick-user-subscriptions-service";
import { emoteIpcContracts } from "@shared/ipc-contracts/emote-contracts";
import { IPC_CHANNELS } from "@shared/ipc-channels";
import { readEmoteReply } from "./emote-ipc-reply";
import type { TrustedIpcRegistry } from "../../../ipc/trusted-ipc-registry";
