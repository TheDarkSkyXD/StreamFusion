...
describe("category-endpoints", () => {
  let getTopCategories: typeof import("@backend/features/discovery/adapters/kick/category-endpoints").getTopCategories;
  let searchCategories: typeof import("@backend/features/discovery/adapters/kick/category-endpoints").searchCategories;
  let getCategoryById: typeof import("@backend/features/discovery/adapters/kick/category-endpoints").getCategoryById;
  let getAllCategories: typeof import("@backend/features/discovery/adapters/kick/category-endpoints").getAllCategories;

  beforeEach(async () => {
    mockFetch.mockReset();
    vi.resetModules();
    ({ getTopCategories, searchCategories, getCategoryById, getAllCategories } =
      await import("@backend/features/discovery/adapters/kick/category-endpoints"));
  });
