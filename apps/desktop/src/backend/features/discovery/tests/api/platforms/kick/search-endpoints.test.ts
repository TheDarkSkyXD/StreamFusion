...
import { searchCategories } from "@backend/features/discovery/adapters/kick/category-endpoints";
...
import {
  ...
  search,
  searchChannels,
} from "@backend/features/discovery/adapters/kick/search-endpoints";
import {
  getPublicTopStreams,
  getStreamBySlug,
} from "@backend/features/discovery/adapters/kick/stream-endpoints";
