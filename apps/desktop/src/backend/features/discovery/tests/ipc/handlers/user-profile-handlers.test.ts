...
vi.mock("@backend/features/discovery/adapters/twitch/twitch-public-profile-reader", () => readerMocks);
vi.mock("@backend/features/discovery/adapters/kick/kick-public-profile-reader", () => readerMocks);

import { registerUserProfileHandlers } from "@backend/features/discovery/routes/user-profile-routes";
