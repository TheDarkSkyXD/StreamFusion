...
import { getUserProfileFixture } from "@shared/user-profile-fixtures";
      ...
      readWithDevelopmentFixture<TwitchPublicIdentity>(
        ...
        async () => {
          const { getTwitchPublicIdentity } =
            await import("../adapters/twitch/twitch-public-profile-reader");
      ...
      readWithDevelopmentFixture<KickPublicIdentity>(
        ...
        async () => {
          const { getKickPublicIdentity } =
            await import("../adapters/kick/kick-public-profile-reader");
