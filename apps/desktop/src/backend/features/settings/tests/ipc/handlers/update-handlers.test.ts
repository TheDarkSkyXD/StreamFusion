...
vi.mock("@backend/features/settings/adapters/electron/update-service", () => ({
...
import { registerUpdateHandlers } from "@backend/features/settings/routes/update-routes";
...
import {
  ...
  setAllowPrerelease,
  setAutoCheck,
} from "@backend/features/settings/adapters/electron/update-service";
