...
} from "../data/diagnostics-history-recorder";
import type { ObservabilitySnapshot } from "../adapters/node/diagnostics-observability";
import type { CpuSpeedLimitReading } from "../adapters/node/cpu-speed-limit-source";
import type { ProcessIoSnapshot } from "../adapters/node/process-io-sampler";
