...
import { type CpuSpeedLimitReading, readWindowsCpuSpeedLimit } from "../adapters/node/cpu-speed-limit-source";
import { diagnosticsObservability } from "../adapters/node/diagnostics-observability";
import { DiagnosticsRuntime, type ElectronProcessMetric } from "./diagnostics-runtime";
import { createProcessIoSampler } from "../adapters/node/process-io-sampler";
