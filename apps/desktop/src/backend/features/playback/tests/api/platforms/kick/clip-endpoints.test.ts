...
describe("clip-endpoints — getClipsByChannelSlug", () => {
  let getClipsByChannelSlug: typeof import("@backend/features/playback/adapters/kick/clip-endpoints").getClipsByChannelSlug;
  let getClipsByCategorySlug: typeof import("@backend/features/playback/adapters/kick/clip-endpoints").getClipsByCategorySlug;
  ...
  beforeEach(async () => {
    ...
    ({ getClipsByChannelSlug, getClipsByCategorySlug } =
      await import("@backend/features/playback/adapters/kick/clip-endpoints"));
  });
