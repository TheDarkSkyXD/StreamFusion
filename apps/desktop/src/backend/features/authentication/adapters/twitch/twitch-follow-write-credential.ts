...
export class TwitchFollowWriteCredentialService {
  ...
  constructor(dependencies: TwitchFollowWriteCredentialDependencies = {}) {
    this.storage =
      ...
      ({
        get: () => authenticationRepository.getTwitchFollowWriteToken(),
        save: (token) => authenticationRepository.saveTwitchFollowWriteToken(token),
        clear: () => authenticationRepository.clearTwitchFollowWriteToken(),
