...
import { deviceCodeFlowService, runTwitchDeviceCodeLogin } from "@backend/features/authentication/adapters/twitch/device-code-flow";
...
describe("requestDeviceCode", () => {
  ...
  it("throws when client ID is not set", async () => {
    const { getOAuthConfig } = await import("@backend/features/authentication/adapters/oauth/oauth-config");
