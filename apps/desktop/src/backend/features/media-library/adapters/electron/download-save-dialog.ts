...
import { buildDownloadFilename } from "../node/download-paths";
...
export function chooseDefaultDownloadSavePath(
  ...
  return chooseDownloadSavePath(input, {
    ...
    getRememberedDirectory: () => mediaLibraryPersistence.getLastDownloadDirectory(),
    rememberDirectory: (directory) => mediaLibraryPersistence.saveLastDownloadDirectory(directory),
