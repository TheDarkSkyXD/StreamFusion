...
import { createStreamRecordingOutcomeCoordinator } from "@backend/features/media-library/domain/stream-recording-outcome-coordinator";
import { createOwnedRecordingSectionPath } from "@backend/features/media-library/adapters/node/stream-recording-paths";
import { createStreamRecordingService } from "@backend/features/media-library/domain/stream-recording-service";
import { createStreamRecordingTestLifecycle } from "./stream-recording-lifecycle-test-runtime";
...
import { testVideoPath } from "../../../../../../tests/backend/services/stream-recording-test-paths";
...
describe("direct-to-file Stream Recording service", () => {
  it("stops capture, deletes only the active session's owned sections, and clears without a notice", async () => {
    ...
    const service = createStreamRecordingService({
      lifecycle: createStreamRecordingTestLifecycle(),
      sessionStore,
