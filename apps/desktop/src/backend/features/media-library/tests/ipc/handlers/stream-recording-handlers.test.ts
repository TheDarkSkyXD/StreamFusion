...
vi.mock("@backend/features/media-library/composition/stream-recording-runtime", () => ({
  getDefaultStreamRecordingService: vi.fn(),
}));
vi.mock("@backend/features/media-library/data/stream-recording-session-store", () => ({
  getStreamRecordingSessionStore: vi.fn(),
}));

import type { BrowserWindow } from "electron";
import { ipcMain } from "electron";
import { registerStreamRecordingHandlers as registerWithRenderer } from "@backend/features/media-library/routes/stream-recording-routes";
import { getDefaultStreamRecordingService } from "@backend/features/media-library/composition/stream-recording-runtime";
import type { StreamRecordingService } from "@backend/features/media-library/domain/stream-recording-service";
import type { StreamRecordingSessionStore } from "@backend/features/media-library/data/stream-recording-session-store";
import { getStreamRecordingSessionStore } from "@backend/features/media-library/data/stream-recording-session-store";
