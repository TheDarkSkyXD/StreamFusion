...
vi.mock("@backend/features/media-library/composition/download-queue-runtime", () => ({
  getDownloadQueueService: vi.fn(),
}));

vi.mock("@backend/features/media-library/adapters/electron/download-file-actions-service", () => ({
  getDefaultDownloadFileActionsService: vi.fn(),
}));

vi.mock("@backend/features/media-library/composition/clip-download-runtime", () => ({
  getDefaultClipDownloadService: vi.fn(),
}));

vi.mock("@backend/features/media-library/composition/video-download-runtime", () => ({
...
import { registerDownloadHandlers as registerWithRenderer } from "@backend/features/media-library/routes/download-routes";
import { isAllowedSender } from "@backend/ipc/sender-origin";
import { getDefaultClipDownloadService } from "@backend/features/media-library/composition/clip-download-runtime";
import { getDefaultDownloadFileActionsService } from "@backend/features/media-library/adapters/electron/download-file-actions-service";
import { getDownloadQueueService } from "@backend/features/media-library/composition/download-queue-runtime";
import { getDefaultVideoDownloadService } from "@backend/features/media-library/composition/video-download-runtime";
import type { DownloadQueueService } from "@backend/features/media-library/domain/download-queue-service";
import type { ClipDownloadService } from "@backend/features/media-library/domain/clip-download-service";
import type { VideoDownloadService } from "@backend/features/media-library/domain/video-download-service";
import type { DownloadFileActionsService } from "@backend/features/media-library/adapters/electron/download-file-actions-service";
import { createMainRendererPortMock } from "../../../../../../../tests/helpers/main-renderer-port-mock";
