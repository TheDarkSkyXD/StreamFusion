...
import {
  ...
  useCategoryMedia,
} from "@/hooks/queries/useCategoryMedia";
import { useFollowedClipPlayback } from "@/hooks/queries/useFollowedContent";
import type { CategoryPlatformScope } from "@/routes/category-detail-search";
