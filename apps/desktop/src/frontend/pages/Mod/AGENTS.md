...
- `src/frontend/features/moderation/data/useModLog.ts` — mod-log IPC hook
- `src/frontend/features/moderation/data/useResolveTwitchChannel.ts` — login-to-id resolution
