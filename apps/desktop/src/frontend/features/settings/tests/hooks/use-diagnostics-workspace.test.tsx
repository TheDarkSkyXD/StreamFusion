...
vi.mock("@/features/settings/composition/diagnostics/renderer-diagnostics-reporter", () => ({
...
describe("useDiagnosticsWorkspace", () => {
  ...
  it("opens each effect lifetime with a unique document instance", async () => {
    ...
    const { useDiagnosticsWorkspace } =
      await import("@/features/settings/components/hooks/use-diagnostics-workspace");
