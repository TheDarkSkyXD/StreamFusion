...
} from "@/features/playback/components/state/seek-interval-store";
...
vi.mock("@/features/auth/components/hooks/useAuth", () => ({
...
vi.mock("@/features/playback/components/state/adblock-store", () => ({
...
import { SettingsPage } from "@/features/settings/components/screens/Settings";
