...
import { useDiagnosticsWorkspace } from "@/features/settings/components/hooks/use-diagnostics-workspace";
import { useDiagnosticsResourceHistory } from "@/features/settings/components/hooks/use-diagnostics-resource-history";
    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex flex-wrap items-center gap-3 p-5">
          <Button variant="outline" onClick={() => getDesktopControls()?.toggleDevTools()}>
