...
import { createNetworkStatusStore } from "@/features/settings/components/hooks/network-status-store";

const useBrowseSnapshotBootstrap = vi.hoisted(() => vi.fn());

vi.mock("@/features/discovery/components/hooks/queries/browse-snapshot-bootstrap", () => ({
