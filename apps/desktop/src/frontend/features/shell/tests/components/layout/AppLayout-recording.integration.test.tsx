...
import { installElectronAPIMock, renderWithProviders, routerMock, screen } from "../../../../../../../tests/test-utils";
...
vi.mock("@/features/auth/components/hooks/useAuth", () => ({ useAuthInitialize: vi.fn() }));
