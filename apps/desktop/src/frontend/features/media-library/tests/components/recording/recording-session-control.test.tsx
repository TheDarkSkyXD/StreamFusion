...
vi.mock("@/features/media-library/components/hooks/use-stream-recording-state", () => ({
  useStreamRecordingState: () => mocks.state,
}));
vi.mock("@/features/media-library/components/hooks/use-stream-recording-actions", () => ({
