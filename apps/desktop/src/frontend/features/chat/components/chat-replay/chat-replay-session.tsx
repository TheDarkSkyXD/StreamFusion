...
function ChatReplayLoadingPanel({ presentation, onClose }: ReplayStatusPanelProps) {
  ...
  return (
    ...
    >
      ...
      <div role="status" aria-label={t("chat.loadingChatReplay")} className="space-y-4 px-4 py-5">
  ...
  return (
    ...
    >
      ...
      <div role="alert" className="m-4 rounded-lg border border-[#333333] bg-[#252525] p-4">
        <p className="text-sm font-semibold">{t("chat.chatReplayIsTemporarilyUnavailable")}</p>
        <p className="mt-1 text-xs text-[#a0a0a0]">{reason}</p>
        <button
          type="button"
          aria-label={t("chat.retryChatReplay")}
  ...
  return (
    ...
    >
      {isDrawerOpen ? (
        <div
          role="dialog"
          aria-label={t("chat.chatReplayDrawer")}
          aria-modal="false"
          className="size-full"
        >
        ...
        <button
          type="button"
          aria-label={t("chat.openChatReplay")}
          aria-expanded="false"
