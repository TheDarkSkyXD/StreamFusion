 ...
 *
 * Two sections today: Predictions (U25) and Polls (U26). The tab is rendered
 * only for the Twitch broadcaster (gated by U19's visibility logic in
 * TwitchChat) — components here assume the current user IS the broadcaster
 * of `channelId`.
 *
