...
} from "@/features/chat/components/state/multi-chat-feed";
...
import { fixtures, installElectronAPIMock, renderWithProviders } from "../../../../../../tests/test-utils";
...
vi.mock("@/features/chat/adapters/browser/twitch-chat", () => ({ twitchChatService: mocks.twitch }));
vi.mock("@/features/chat/adapters/browser/kick-chat", () => ({ kickChatService: mocks.kick }));
...
vi.mock("@/features/chat/components/hooks/use-chat-message-router", () => ({
