...
import { createIpcReplyMock } from "../../../../../../../tests/helpers/ipc-reply-mock";
...
import { BTTVEmoteProvider, bttvEmoteProvider } from "@backend/../frontend/features/chat/adapters/browser/emotes/bttv-emotes";
