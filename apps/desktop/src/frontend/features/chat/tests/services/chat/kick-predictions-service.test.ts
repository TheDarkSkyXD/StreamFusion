...
import { kickChatService, getKickPusher } from "@backend/../frontend/features/chat/adapters/browser/kick-chat";
import { kickPredictionsService } from "@backend/../frontend/features/chat/adapters/browser/kick-predictions-service";
import * as kickPredictionsApi from "@backend/../frontend/features/chat/adapters/browser/kick-predictions";
