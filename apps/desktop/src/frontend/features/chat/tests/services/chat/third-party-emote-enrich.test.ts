...
import { substituteThirdPartyEmotes } from "@backend/../frontend/features/chat/domain/third-party-emote-enrich";
import type { Emote } from "@backend/../frontend/features/chat/capabilities/emote-types";
