...
import { parseKickRaidNotification } from "@backend/../frontend/features/chat/adapters/browser/kick-parser";
import { parseTwitchRaidNotification } from "@backend/../frontend/features/chat/adapters/browser/twitch-hermes-client";
