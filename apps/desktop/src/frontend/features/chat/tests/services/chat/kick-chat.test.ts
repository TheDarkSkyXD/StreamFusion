import { chatChannelLifecycle } from "@/features/chat/components/state/chat-channel-lifecycle";
...
import { KickChatService } from "@backend/../frontend/features/chat/adapters/browser/kick-chat";
import { buildChannelKey, useChatStore } from "@/features/chat/components/state/chat-store";
import type { ChatMessage } from "@shared/chat-types";
import type { KickChatMessageEvent } from "@backend/../frontend/features/chat/adapters/browser/kick-parser";
...
function makeService(): { service: KickChatService; internals: ServiceInternals } {
  const service = new KickChatService(chatChannelLifecycle);
