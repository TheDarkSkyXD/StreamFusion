...
} from "@backend/../frontend/features/chat/adapters/browser/kick-parser";
import { parseTwitchMessage, type TwitchTags } from "@backend/../frontend/features/chat/domain/twitch-parser";
