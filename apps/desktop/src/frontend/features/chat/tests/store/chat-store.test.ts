...
import type { ChatConnectionStatus, ChatMessage } from '@shared/chat-types';
...
import { buildChannelKey, DEFAULT_BATCHING_INTERVAL_MS, useChatStore } from '@/features/chat/components/state/chat-store';
