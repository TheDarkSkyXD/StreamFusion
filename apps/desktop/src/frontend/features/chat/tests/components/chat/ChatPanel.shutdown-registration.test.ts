...
vi.mock("@/features/shell/composition/app-shutdown-registry", () => ({ registerAppShutdownTask }));
vi.mock("@/features/chat/composition/emote-runtime", () => ({ ensureEmoteProvidersInitialized: vi.fn() }));
...
vi.mock("@/features/chat/composition/chat-service-loader", () => ({
