...
import { KickChatSendError, kickChatService } from "@/features/chat/adapters/browser/kick-chat";
...
import { HANDLED_CHAT_COMMAND } from "@/features/chat/domain/commands/chat-command-outcome";
