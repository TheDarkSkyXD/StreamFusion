...
vi.mock("@/features/chat/adapters/browser/seven-tv-cosmetics-client", () => ({
...
vi.mock("@/features/chat/components/state/chat-cosmetics-store", () => ({
...
vi.mock("@/features/auth/components/hooks/useRequireModScopes", () => ({
  useRequireModScopes: () => ({
...
vi.mock("@/features/moderation/components/hooks/useIsTwitchMod", () => ({
...
vi.mock("@/features/chat/adapters/browser/twitch-hermes-client", () => ({
...
const getTwitchEventSubClient = vi.fn();
const getModeratedChannelsResult = vi.fn();
