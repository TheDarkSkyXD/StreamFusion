...
import type { Emote, EmoteManagerConfig, EmoteProvider, EmoteProviderService } from "../../capabilities/emote-types";
import { DEFAULT_EMOTE_CONFIG } from "../../capabilities/emote-types";
