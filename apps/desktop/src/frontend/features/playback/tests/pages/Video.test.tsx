...
vi.mock("@/features/media-library/components/hooks/useHistoryQuery", () => ({
...
import { VideoPage } from "@/features/playback/components/screens/Video";
import { CHANNEL_KEYS } from "@/features/discovery/components/hooks/queries/useChannels";
import { VOD_LIVE_LINK_KEYS } from "@/features/playback/components/hooks/useVodLiveLink";
