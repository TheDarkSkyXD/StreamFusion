...
import { ClipDialog } from "../../../components/related-content/ClipDialog";
import { makeClip, relatedChannel } from "./related-content-story-fixtures";
import { RelatedContentStoryRouter } from "../../../components/related-content/related-content-story-router";
...
export const KickError: Story = {
  args: {
    selectedClip: makeClip(1, { platform: "kick", vodId: "991188" }),
    platform: "kick",
