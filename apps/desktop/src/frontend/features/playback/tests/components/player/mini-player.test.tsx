...
vi.mock("@/features/playback/components/hooks/useStreamPlayback", () => streamPlaybackMock);
vi.mock("@/features/discovery/components/hooks/queries/useStreams", () => streamStatusMock);
