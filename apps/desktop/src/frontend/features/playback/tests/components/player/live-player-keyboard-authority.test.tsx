...
vi.mock("@/features/playback/components/hooks/use-ad-element-observer", () => ({ useAdElementObserver: vi.fn() }));
vi.mock("@/features/playback/components/state/adblock-store", () => ({ useAdBlockStore: () => false }));
