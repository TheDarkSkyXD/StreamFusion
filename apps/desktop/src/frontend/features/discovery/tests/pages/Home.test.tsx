...
import type { useInfiniteTopStreams } from "@/features/discovery/components/hooks/queries/useInfiniteStreams";

import { fixtures, renderWithProviders, routerMock, screen } from "../../../../../../tests/test-utils";
...
vi.mock("@/features/discovery/components/screens/Home/components/featured-stage", () => ({
  FeaturedStage: ({
    stream,
    streams,
    isLoading,
...
vi.mock("@/features/discovery/components/screens/Home/components/live-now-section", () => ({
  LiveNowSection: ({ streams }: { streams: unknown[] }) => (
    <div data-testid="live-now">streams: {streams.length}</div>
  ),
}));

import { HomePage } from "@/features/discovery/components/screens/Home";
