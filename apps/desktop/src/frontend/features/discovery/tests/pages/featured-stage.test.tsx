...
import { HOME_CAROUSEL_INTERVAL_DEFAULT_MS, useAppStore } from "@/features/shell/components/state/app-store";

import { fireEvent, fixtures, renderWithProviders, screen } from "../../../../../../tests/test-utils";
...
import { FeaturedStage } from "@/features/discovery/components/screens/Home/components/featured-stage";
