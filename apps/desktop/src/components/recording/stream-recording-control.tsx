...
import { ActiveRecordingDialog } from "@/components/stream/active-recording-dialog";
...
import { RecordingSessionControls } from "@/components/recording/recording-session-control";
