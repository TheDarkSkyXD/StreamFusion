...
import * as StreamEndpoints from "../../../features/discovery/adapters/twitch/stream-endpoints";
    ...
    FollowedStreamReader<"twitch", UnifiedStream, PaginationOptions>
{
  ...
  async getChannelsById(ids: string[]): Promise<UnifiedChannel[]> {
    ...
    const ChannelEndpoints = await import("../../../features/discovery/adapters/twitch/channel-endpoints");
  ...
  async searchChannels(
    ...
    if (this.isAuthenticated()) {
      try {
        const SearchEndpoints = await import("../../../features/discovery/adapters/twitch/search-endpoints");
  ...
  async getTopCategories(
    ...
    try {
      ...
      const CategoryEndpoints = await import("../../../features/discovery/adapters/twitch/category-endpoints");
  ...
  async getVideosByGame(
    ...
    const VideoEndpoints = await import("../../../features/playback/adapters/twitch/video-endpoints");
  ...
  async getClipsByGame(
    ...
    const ClipEndpoints = await import("../../../features/playback/adapters/twitch/clip-endpoints");
