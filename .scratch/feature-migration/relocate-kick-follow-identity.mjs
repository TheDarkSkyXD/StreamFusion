...
const relocation = prepareRelocation(root, [{
  from: "apps/desktop/src/backend/features/authentication/domain/kick-follow-identity-service.ts",
  to: "apps/desktop/src/backend/features/authentication/adapters/kick/kick-follow-identity-service.ts",
