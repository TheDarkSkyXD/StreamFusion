...
"@
$record=[ordered]@{handle=71552; appUserModelId=[TaskbarPropertyProbe]::Read(71552,5);relaunchIconResource=[TaskbarPropertyProbe]::Read(71552,3);relaunchCommand=[TaskbarPropertyProbe]::Read(71552,2);relaunchDisplayName=[TaskbarPropertyProbe]::Read(71552,4)}
$record|ConvertTo-Json|Set-Content .scratch/feature-migration/taskbar-properties-before.json
