...
const relocation = prepareRelocation(root, [{
  from: "apps/desktop/src/backend/features/moderation/domain/moderation-history-authorization.ts",
  to: "apps/desktop/src/backend/features/moderation/adapters/platform/moderation-history-authorization.ts",
