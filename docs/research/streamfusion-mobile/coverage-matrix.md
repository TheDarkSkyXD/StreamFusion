...
| `action:notification-permission` | implemented | #169, #172 | apps/mobile/src/features/settings/adapters/android-notification-permission.ts, apps/mobile/src/features/settings/components/notifications-settings-panel.tsx, apps/mobile/src/features/notifications/domain/native-notification-runtime.ts | tests |
...
| `GAP-195-03` | owned-elsewhere | Chat Settings remains M06. Diagnostics six-tab workspace ships on M09. Updates/Logs/Report/About Settings persist locally. GitHub Check now inspects the latest stable release without APK download. Native FCM registration and topic/direct fanout ship on N01–N02; 100k public-release dispatch stays N03. | #143, #168, #169, #170, #171, #172, #173, #174 |
| `GAP-195-04` | owned-elsewhere | Guest notification preferences, Android permission, native FCM registration, in-app banners, ended-stream routing, and topic/direct fanout live on this build. Public-release 100k dispatch remains N03. Activity stays a local inbox plus relay receipts. | #151, #169, #172, #173, #174 |
