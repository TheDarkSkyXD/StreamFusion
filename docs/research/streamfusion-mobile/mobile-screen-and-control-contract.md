...
| <!-- contract:action:account-add -->`account-add`                         | Select Twitch Device Code or Kick PKCE, including pending, denied, expired and retry states; Guest mode remains separate.    | #145, #146           |
| <!-- contract:action:account-manage -->`account-manage`                   | Inspect scope/expiry/refresh status and confirm targeted disconnect without showing secrets.                                 | #145, #146           |
